...
@register("Кухня Шампань 1000х1800")
def build_kitchen_shampan(article: str) -> dict:
    u = lambda name: img_url(name, article)
    return {
        "version": 0.3,
        "content": [
            title_text_block(
                "Кухня Sanvut Шампань угловая 1,8 м — белый/сатин",
                "Угловой кухонный гарнитур 1800 x 1000 мм: корпус и фасады ЛДСП, отделка сатин, "
                "столешницы под мрамор в комплекте. Модуль под духовку, ящики, навесные шкафы.",
            ),
            {
                "widgetName": "raShowcase",
                "type": "billboard",
                "blocks": [
                    billboard_block(
                        ...
                        1240,
                        1656,
                        "Угловая кухня 1,8 м: размеры и комплектация",
                        "Габариты комплекта 1800 x 1000 мм.",
                        "Высота напольных модулей 824 мм, навесных 710 мм.",
                        "Корпус и фасады ЛДСП, столешницы в комплекте.",
                        "4 напольных и 3 навесных модуля, ручки 9 шт.",
                        "Артикул производителя Кухня Шампань 1000х1800.",
                        alt="Кухня Шампань угловая — инфографика",
                    )
                ],
            },
            {
                ...
                "blocks": [
                    chess_block(
                        ...
                        1024,
                        "Кухня в интерьере",
                        "Светлая угловая кухня для квартиры и студии — белый сатин и мраморная столешница.",
                        False,
                        "Кухня Шампань в интерьере",
                    ),
                    chess_block(
                        u("06-layout.png"),
                        768,
                        1024,
                        "Состав комплекта",
                        "Верх: 2 модуля 600 мм и посудосушитель. Низ: угол 1000 мм, ящики, модуль под духовку 450 мм.",
                        True,
                    ...
                    chess_block(
                        ...
                        "Петли с доводчиком, направляющие до 30 кг, кромка ПВХ, фасады со свесом 12 мм.",
                        False,
                        "Детали фасадов ЛДСП",
                    ),
                    chess_block(
                        ...
                        768,
                        1024,
                        "Компактный угол 1,8 м",
                        "Готовый гарнитир Sanvut для небольшой кухни — столешницы и ручки уже в комплекте.",
                        True,
                        "Угловая кухня 180 см",
                    ),
                ],
            },
            {
                ...
                "type": "roll",
                "blocks": [
                    roll_block(u("01-main.png"), 768, 1024, "Кухня Шампань — главное фото"),
                    roll_block(u("05-angle.png"), 768, 1024, "Кухня Шампань — ракурс"),
                ],
            },
            text_block(
                "Комплектация и доставка",
                "В комплекте: модули, 2 столешницы, ручки, фурнитура, инструкция. Поставка в разборе, "
                "несколько упаковок (КГТ, realFBS). Варочная панель и духовка не входят. "
                "Производитель Sanvut, Екатеринбург, Россия. Гарантия 12 месяцев.",
            ),
        ],
    }
...
@register("Ц0074620")
def build_kitchen_mori(article: str) -> dict:
    u = lambda name: img_url(name, article)
    return {
        "version": 0.3,
        "content": [
            title_text_block(
                "Кухня Мори 2,0 м графит/дуб вотан — комплект ДСВ",
                "Модульный кухонный гарнитур 200 см: корпус и фасады ЛДСП графит, интегрированные ручки. "
                "В комплекте 2 столешницы под модули, цоколь и фурнитура. Мойка и сушка не входят.",
            ),
            {
                "widgetName": "raShowcase",
                "type": "billboard",
                "blocks": [
                    billboard_block(
                        ...
                        1240,
                        1656,
                        "Кухня 2 метра: размеры и состав",
                        "Ширина комплекта 2000 мм.",
                        "Корпус и фасады ЛДСП, цвет графит/дуб вотан.",
                        "2 столешницы в комплекте, модуль под мойку без столешницы.",
                        "6 модулей: 3 напольных, 3 навесных.",
                        "Артикул производителя Ц0074620.",
                        alt="Кухня Мори 2 м — инфографика",
                    )
                ],
            },
            {
                ...
                "blocks": [
                    chess_block(
                        ...
                        1024,
                        "Кухня в интерьере",
                        "Компактная кухня 2 м для квартиры — графит с интегрированными ручками.",
                        False,
                        "Кухня Мори в интерьере",
                    ),
                    chess_block(
                        u("06-layout.png"),
                        768,
                        ...
                        "Низ: ящики 400 мм, полка 800 мм, модуль под мойку 800 мм. Верх: 400 мм и 800 мм x2.",
                        True,
                        "Планировка модулей Мори",
                    ),
                    chess_block(
                        u("04-details.png"),
                        768,
                        1024,
                        "Фасады и столешница",
                        "ЛДСП с интегрированной ручкой, столешница под дуб вотан, роликовые направляющие ящиков.",
                        False,
                        "Детали кухни Мори",
                    ),
                    chess_block(
                        ...
                        768,
                        1024,
                        "2 метра — готовое решение",
                        "Полный набор модулей для небольшой кухни, столешницы уже в комплекте.",
                        True,
            ...
            },
            {
                ...
                "type": "roll",
                "blocks": [
                    roll_block(u("01-main.png"), 768, 1024, "Кухня Мори — главное фото"),
                    roll_block(u("05-angle.png"), 768, 1024, "Кухня Мори — ракурс"),
                ],
            },
            text_block(
                "Комплектация и доставка",
                "В комплекте: напольные и навесные модули, 2 столешницы, цоколь, фурнитура, инструкция. "
                "Мойка и сушка не входят. Поставка в разборе. Производитель ДСВ, Пенза, Россия. Гарантия 24 месяца.",
            ),
        ],
    }
...
@register("Гостиная Гориция НСМ Сапфировый")
def build_goritsiya_gostinaya(article: str) -> dict:
    u = lambda name: img_url(name, article)
    return {
        "version": 0.3,
        "content": [
            title_text_block(
                "Гостиная Браво Гориция НСМ Сапфировый",
                "Модульная стенка для гостиной: 8 элементов в цвете сапфировый лак на МДФ "
                "и корпус Таксус. Тумба ТВ, комоды, витрины, шкаф и зеркало. Разборная поставка.",
            ),
            {
                "widgetName": "raShowcase",
                "type": "billboard",
                "blocks": [
                    billboard_block(
                        ...
                        "Тумба ТВ 1511 мм.",
                        "Комод 2 двери 6 ящиков.",
                        "Витрины ШР-1 и ШР-2.",
                        "Шкаф распашной ШР-2.",
                        "Зеркало навесное.",
                        alt="Гориция НСМ — состав комплекта",
                    )
                ],
            },
            {
                ...
                "blocks": [
                    chess_block(
                        ...
                        1024,
                        "Готовая гостиная",
                        "Единый стиль коллекции Гориция — не нужно подбирать модули по отдельности.",
                        False,
                        "Гостиная Гориция lifestyle",
                    ),
                    chess_block(
                        u("06-layout.png"),
                        768,
                        1024,
                        "8 модулей в комплекте",
                        "Тумба под ТВ, комоды с ящиками, витрины со стеклом, шкаф и зеркало.",
                        True,
                        "Модули Гориция НСМ",
                    ),
                    chess_block(
                        ...
                        1024,
                        "Фасады и фурнитура",
                        "МДФ с полиуретановой эмалью, фрезеровка, направляющие с доводчиками, опоры массив.",
                        False,
                        "Детали фасада Гориция",
                    ),
                    chess_block(
                        u("07-utp.png"),
                        768,
                        1024,
                        "Модульная система",
                        "Соберите композицию под размер комнаты — модули серии совместимы по стилю.",
                        True,
                        "Модульность Гориция",
                    ),
                ],
            },
            {
                ...
                "type": "roll",
                "blocks": [
                    roll_block(u("01-main.png"), 768, 1024, "Гориция НСМ — главное фото"),
                    roll_block(u("05-angle.png"), 768, 1024, "Гориция НСМ — ракурс"),
                ],
            },
            text_block(
                "Комплектация и доставка",
                "8 модулей, фурнитура, инструкции. Поставка в разобранном виде, 8 упаковок. "
                "Производитель Браво Мебель, Россия. Гарантия 24 месяца.",
            ),
        ],
    }

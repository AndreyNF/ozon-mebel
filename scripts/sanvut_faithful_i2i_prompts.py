...
SLOTS: dict[str, dict] = {
    ...
    "08-cooktop-gas.png": {
        "refs": [MAIN_REF],
        "prompt": (
            f"{FIDELITY_RU} Крупнее модуль 450 мм под варку: на столешнице схематично газовая панель "
            "(не в комплекте). Та же кухня, без второй плиты."
        ),
    },
    "09-cooktop-electric.png": {
        "refs": [MAIN_REF],
        "prompt": (
            f"{FIDELITY_RU} Тот же модуль 450 мм: схематично электрическая панель (не в комплекте). "
            "Одна зона готовки, без лишних модулей."
        ),
    },
    "10-cooktop-induction.png": {
        "refs": [MAIN_REF],
        "prompt": (
            f"{FIDELITY_RU} Тот же модуль 450 мм: схематично индукционная панель (не в комплекте). "
            "Цвета и конфигурация кухни без изменений."
        ),
    },
}

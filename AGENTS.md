...
5. **Серия фото (обязательно)** — **10 кадров 3:4** в `cards/{АРТ}/images/` (`01-main` … `10-*`), промпты в `docs/prompts-by-category.md`, правило: `docs/ozon-photo-series.md`, `.cursor/rules/ozon-photo-series-10.mdc`. **Кухня:** слоты `08-cooktop-gas`, `09-cooktop-electric`, `10-cooktop-induction`. Без 10 фото **не загружать** в Ozon.
